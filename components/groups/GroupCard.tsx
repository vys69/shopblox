        ...
        <Card className="w-full text-center border border-zinc-900 shadow-lg bg-zinc-900 border-zinc-800 mt-4 rounded-none">
            <CardContent className="text-zinc-400 font-normal p-6">
                <div className="flex items-center justify-start flex-row space-x-2">
                    <img src={ownerAvatarUrl} alt="Owner Avatar" className="w-16 h-16 ml-2 rounded-full bg-black" />
                    <div className="flex flex-col">
                        ...
                        <p className="text-sm text-zinc-500">{groupData.memberCount} members</p>
                        <p className="text-sm text-zinc-500">{groupData.description.substring(0, 10) + '...'}</p>
                    </div>
                </div>
            </CardContent>
        </Card>
